...
problems = {
    ...
    'test_batch_norm_train': ('Batch Normalization (training time)', 12),
    'test_batch_norm_inference': ('Batch Normalization (inference time)', 6),
    ...
    'test_linear_classifier_step': ('Linear Classifier (step)', 2),

    'test_single_hidden_forward': ('Single Hidden Layer (forward)', 5),
    'test_single_hidden_backward': ('Single Hidden Layer (backward)', 5),
    'test_mystery_hidden_forward1': ('N Hidden Layer (forward) 1', 6),
    'test_mystery_hidden_forward2': ('N Hidden Layer (forward) 2', 6),
    'test_mystery_hidden_forward3': ('N Hidden Layer (forward) 3', 6),
    'test_mystery_hidden_backward1': ('N Hidden Layer (backward) 1', 6),
    'test_mystery_hidden_backward2': ('N Hidden Layer (backward) 2', 6),
    'test_mystery_hidden_backward3': ('N Hidden Layer (backward) 3', 6),
